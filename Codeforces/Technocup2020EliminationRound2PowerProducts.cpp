/// the map compares items using the "<" which vectors support - allowing maps to get keys by value
/// unordered_map compares items using hash ids and direct comparisons. Only primitive types (int, string, etc.) have built in hashing and compare functions
/// To allow unordered_map to get keys by value, define a hashing and direct comparision function and pass like this: unordered_map<type, n, hashing_function, comparison_function>
